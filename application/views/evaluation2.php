					...
					<div class="col-md-3">
						<table>
							...
							<tr>
								...
								<td><input type="radio" name="orig_rating_2" value="5" <?php echo set_radio('orig_rating_2', '5'); ?> /></td>
							</tr>
						</table>
					</div>
					...
					<div class="col-md-3">
						<table>
							...
							<tr>
								...
								<td><input type="radio" name="mod_rating_2" value="5" <?php echo set_radio('mod_rating_2', '5'); ?> /></td>
							</tr>
						</table>
					</div>
